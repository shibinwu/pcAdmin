    ...
    <div class="centercontent tables">
        ...
        <div id="contentwrapper" class="contentwrapper">
            <div class="contenttitle2">
                <h3><a href="<?php echo U('add_node','','');?>">添加模块</a></h3>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                <?php if(is_array($node)): foreach($node as $key=>$app): ?><div class="app">
                        <p>
                            ...
                            <a href="<?php echo U('add_node',array('pid'=>$app['id'],'level'=>2),'');?>">
                                [添加控制器]
                            </a>
                            <a href="">[修改]</a>
                            <a href="">[删除]</a>
                        ...
                        <?php if(is_array($app["child"])): foreach($app["child"] as $key=>$controller): ?><dl>
                                <dt>
                                    ...
                                    <a href="<?php echo U('add_node',array('pid'=>$controller['id'],'level'=>3),'');?>">
                                        [添加方法]
                                    </a>
                                    <a href="">[修改]</a>
                                    <a href="">[删除]</a>
                                ...
                                <?php if(is_array($controller["child"])): foreach($controller["child"] as $key=>$method): ?><div>
                                        &nbsp;&nbsp;&nbsp;&nbsp;-
