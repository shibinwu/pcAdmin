    ...
    <div class="centercontent tables">
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                ...
                <thead>
                <tr>
                    <th class="head0">BannerId</th>
                    <th class="head1">图片地址</th>
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($vol["bnid"]); ?></td>
                        <td><?php echo ($vol["bn_pic"]); ?></td>
                        <td><?php if($vol["type"] == 1): ?>首页
                            <?php elseif($vol["type"] ==2): ?>商城
                            <?php elseif($vol["type"] ==3): ?>资讯
                            <?php else: ?>&nbsp<?php endif; ?>
                        </td>
                        <td>
                            <?php if($vol['status'] == 1): ?>启用<?php else: ?>未启用<?php endif; ?>
                        </td>
                        ...
                        <td class="center" url="/index.php/Admin/Banner"><a href="javascript:;" data-id="<?php echo ($vol["bnid"]); ?>" class="edit">编辑</a> &nbsp; <a href="javascript:;" data-id="<?php echo ($vol["bnid"]); ?>" class="del">删除</a></td>
