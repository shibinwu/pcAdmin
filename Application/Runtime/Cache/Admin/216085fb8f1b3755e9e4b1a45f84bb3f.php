        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable">
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vol["idnum"]); ?></td>
                        <td><?php echo ($vol["weiboid"]); ?></td>
                        <td><?php echo ($vol["openid"]); ?></td>
                        ...
                        <!--</td>-->
                        <td class="center" url="/index.php/Admin/Member"><a href="javascript:;" data-id="<?php echo ($vol["id"]); ?>" class="edit">编辑</a> &nbsp; <a href="javascript:;" data-id="<?php echo ($vol["id"]); ?>" class="del">删除</a></td>
